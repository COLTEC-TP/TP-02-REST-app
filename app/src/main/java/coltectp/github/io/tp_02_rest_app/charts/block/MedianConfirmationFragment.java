...
public class MedianConfirmationFragment extends Fragment {
    public static final String ARG_PAGE = "MEDIAN_CONFIRMATION_TIME";

    private int mPage;

    public static MedianConfirmationFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        MedianConfirmationFragment fragment = new MedianConfirmationFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<Chart> medianConfirmationTimeCall = service.getMedianConfirmationTime(data);

        // fazendo a requisição de forma assíncrona
        medianConfirmationTimeCall.enqueue(new Callback<Chart>() {
            @Override
