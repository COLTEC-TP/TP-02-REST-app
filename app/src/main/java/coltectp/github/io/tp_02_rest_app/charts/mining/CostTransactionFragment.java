...
public class CostTransactionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<Chart> costPerTransactionCall = service.getCostPerTransaction(data);

        // fazendo a requisição de forma assíncrona
        costPerTransactionCall.enqueue(new Callback<Chart>() {
            @Override
