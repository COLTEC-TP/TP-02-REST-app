...
public class TradeVolumeFragment extends Fragment {
    public static final String ARG_PAGE = "TRADE_VOLUME";

    private int mPage;
    private ProgressBar mProgressBar;
    private LineChart mChart;

    public static TradeVolumeFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        TradeVolumeFragment fragment = new TradeVolumeFragment();
    ...
    private void makeCall(final View view) {
        ...
        Call<Chart> tradeVolumeCall = service.getTradeVolume(data);

        // fazendo a requisição de forma assíncrona
        tradeVolumeCall.enqueue(new Callback<Chart>() {
            @Override
