...
public class TransactionFeesFragment extends Fragment {
    public static final String ARG_PAGE = "TRANSACTION_FEES";
    ...
    public static TransactionFeesFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        TransactionFeesFragment fragment = new TransactionFeesFragment();
    ...
    private void makeCall(final View view) {
        ...
        Call<Chart> transactionFeesCall = service.getTransactionFees(data);

        // fazendo a requisição de forma assíncrona
        transactionFeesCall.enqueue(new Callback<Chart>() {
            @Override
