...
public class MarketCapFragment extends Fragment {
    public static final String ARG_PAGE = "MARKET_CAP";

    private int mPage;

    public static MarketCapFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        MarketCapFragment fragment = new MarketCapFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<Chart> marketCapCall = service.getMarketCap(data);

        // fazendo a requisição de forma assíncrona
        marketCapCall.enqueue(new Callback<Chart>() {
            @Override
