...
public class MarketPriceFragment extends Fragment {
    public static final String ARG_PAGE = "MARKET_PRICE";

    private int mPage;

    public static MarketPriceFragment newInstance(int page) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<Chart> marketPriceCall = service.getMarketPrice(data);

        // fazendo a requisição de forma assíncrona
        marketPriceCall.enqueue(new Callback<Chart>() {
            @Override
