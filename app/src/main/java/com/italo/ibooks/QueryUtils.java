...
public class QueryUtils {
    ...
    public static List<Livro> fetchBooksData(String url){
        Log.i(TAG, "fetchBooksData: "+ url);
        ArrayList<Livro> arrayList = null;
    ...
    private static ArrayList<Livro> extractJson(String json) throws JSONException {
        String title = "title";          //titulo
        String author = "author";       //autor
        String infoUrl = "infoUrl";
        String imageUrl = "imageUrl";
        String publisher = "publisher";   //editora
        ...
        for(int i=0; i < items.length(); i++){
            ...
            title = volumeInfo.getString("title");  //titulo
